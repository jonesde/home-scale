...
| HF decouple (film / C0G) | 8→16 | Search Digi-Key: [`100nF 100V C0G radial`](https://www.digikey.com/en/products/filter/ceramic-capacitors/60?keywords=100nF+100V+C0G+radial) or [`1uF 100V film stacked`](https://www.digikey.com/en/products/filter/film-capacitors/62?keywords=1uF+100V+stacked+film) | Any good 100 V+ C0G or polypropylene. LCSC fine later. | $0.15–0.80 | One at each FET + driver VDDA/VDDB/VCCI. |
...
| Bus / output TVS | 2→4 | [5.0SMDJ58A](https://www.digikey.com/en/products/detail/littelfuse-inc/5-0SMDJ58A/2024341) 58 V standoff, SMC (~$2.50) | [SMDJ58A](https://www.digikey.com/en/products/detail/littelfuse-inc/SMDJ58A/2024554); `5.0SMDJ64A` if the bus sits near 60 V. Bidirectional CA suffix if you want AC across the rails. | $1.50–3 | One on the DC bus, one across the rail pads. |
...
| Reverse-polarity (ideal diode) | 1 + FET | [LM74700QDBVRQ1](https://www.digikey.com/en/products/detail/texas-instruments/LM74700QDBVRQ1/10434692) (~$2.10) + one [IRFB4110PBF](https://www.digikey.com/en/products/detail/infineon-technologies/IRFB4110PBF/935978) as the series N-FET | Discrete P-FET; or a series Schottky if you accept the drop. | $2–7 | Optional-if-you-are-careful; recommended on a 48–60 V bench lead. |
...
| Bus / rail voltage divider | 2 sets | Search: [`100k 1% 0.25W`](https://www.digikey.com/en/products/filter/through-hole-resistors/53?keywords=100k+1%25+0.25W) + [`10k 1%`](https://www.digikey.com/en/products/filter/through-hole-resistors/53?keywords=10k+1%25+0.25W) + [`BAT54`](https://www.digikey.com/en/products/filter/diodes-rectifiers-single/280?keywords=BAT54) clamp | 0.1% if you care about absolute volts. | $0.20 | Scale 60 V → ~3 V. Clamp to the MCU rail. |
...
|-------|----------------|
| 3.1 DC input & charging | Reverse-polarity, TVS, charge resistor, bleeders, bus divider |
